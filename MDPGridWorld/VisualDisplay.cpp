...
void VisualDisplay::paintButtons()
{
    ...
    /*Render the labels*/
   // cv::putText(gridworld_img, "Game Mode", Point(button[0].top_let.x + 30 * ratio, button[0].top_let.y + 14 * ratio), FONT_HERSHEY_COMPLEX_SMALL, 0.75 * ratio, Scalar(50, 50, 50), 1, LINE_AA);
    cv::putText(gridworld_img, "MDP Process", Point(button[1].top_let.x - 10 * ratio, button[1].top_let.y - 5 * ratio), FONT_HERSHEY_COMPLEX_SMALL, 0.85 * ratio, Scalar(50, 50, 50), 1, LINE_AA);
    cv::putText(gridworld_img, "Show Q-values", Point(button[2].top_let.x + 30 * ratio, button[2].top_let.y + 14 * ratio), FONT_HERSHEY_COMPLEX_SMALL, 0.7 * ratio, Scalar(50, 50, 50), 1, LINE_AA);
    cv::putText(gridworld_img, "Show Policy", Point(button[3].top_let.x + 30 * ratio, button[3].top_let.y + 14 * ratio), FONT_HERSHEY_COMPLEX_SMALL, 0.7 * ratio, Scalar(50, 50, 50), 1, LINE_AA);

    /*Render the iteration label*/
    char iteration_text[200];
    sprintf(iteration_text, "Iterations: %d", idx);
    cv::putText(gridworld_img, iteration_text, Point(grid_size.x / 2.0 - 50 * ratio, grid_size.y + 15 * ratio), FONT_HERSHEY_COMPLEX_SMALL, 0.7 * ratio, Scalar(50, 50, 50), 1, LINE_AA);
}
    ...
    for(int y = 0; y < 3; y++)
    {
        for(int x = 0; x < 4; x++)
        {
            ...
            if(center_num_sign == 1)
            {
                ...
                cv::putText(gridworld_img, num_char, square[y][x].cen_pos, FONT_HERSHEY_DUPLEX , 0.5 * ratio, Scalar(0, 0, 0), 1, LINE_AA);
            }
            else //draw Q value
            {
                ...
                for(int i = 0; i < 4; i++)
                {
                    ...
                    cv::putText(gridworld_img, num_char, square[y][x].q_pos[i], FONT_HERSHEY_DUPLEX , 0.40 * ratio, Scalar(0, 0, 0), 1, LINE_AA);
                }
            }
...
{
    org_gridworld[0] = imread("/Users/shravyareddyakmy/Desktop/Masters/Summer2022/AI-580/MDP_GridWorld/MDP_GridWorld/imgs/GridWorld.jpg");
    org_gridworld[1] = imread("/Users/shravyareddyakmy/Desktop/Masters/Summer2022/AI-580/MDP_GridWorld/MDP_GridWorld/imgs/GridWorld_cross.jpg");
    ...
    button[0].org_img = imread("/Users/shravyareddyakmy/Desktop/Masters/Summer2022/AI-580/MDP_GridWorld/MDP_GridWorld/imgs/radio_button.png"); //button  0 (Gaming Mode)
    button[0].hov_img = imread("/Users/shravyareddyakmy/Desktop/Masters/Summer2022/AI-580/MDP_GridWorld/MDP_GridWorld/imgs/radio_hover.png");
    button[0].clk_img = imread("/Users/shravyareddyakmy/Desktop/Masters/Summer2022/AI-580/MDP_GridWorld/MDP_GridWorld/imgs/radio_select.png");
    ...
    button[2].org_img = imread("/Users/shravyareddyakmy/Desktop/Masters/Summer2022/AI-580/MDP_GridWorld/MDP_GridWorld/imgs/checkbox_unchecked.png"); //show the Q value
    button[2].hov_img = imread("/Users/shravyareddyakmy/Desktop/Masters/Summer2022/AI-580/MDP_GridWorld/MDP_GridWorld/imgs/checkbox_unchecked.png");
    button[2].clk_img = imread("/Users/shravyareddyakmy/Desktop/Masters/Summer2022/AI-580/MDP_GridWorld/MDP_GridWorld/imgs/checkbox_checked.png");
    ...
    button[3].org_img = imread("/Users/shravyareddyakmy/Desktop/Masters/Summer2022/AI-580/MDP_GridWorld/MDP_GridWorld/imgs/checkbox_unchecked.png"); //show the policy
    button[3].hov_img = imread("/Users/shravyareddyakmy/Desktop/Masters/Summer2022/AI-580/MDP_GridWorld/MDP_GridWorld/imgs/checkbox_unchecked.png");
    button[3].clk_img = imread("/Users/shravyareddyakmy/Desktop/Masters/Summer2022/AI-580/MDP_GridWorld/MDP_GridWorld/imgs/checkbox_checked.png");
    ...
    button[4].org_img = imread("/Users/shravyareddyakmy/Desktop/Masters/Summer2022/AI-580/MDP_GridWorld/MDP_GridWorld/imgs/next.png"); //next button (move one step forward)
    button[4].hov_img = imread("/Users/shravyareddyakmy/Desktop/Masters/Summer2022/AI-580/MDP_GridWorld/MDP_GridWorld/imgs/next_hover.png");
    button[4].clk_img = imread("/Users/shravyareddyakmy/Desktop/Masters/Summer2022/AI-580/MDP_GridWorld/MDP_GridWorld/imgs/next.png");
    ...
    button[5].org_img = imread("/Users/shravyareddyakmy/Desktop/Masters/Summer2022/AI-580/MDP_GridWorld/MDP_GridWorld/imgs/reset.png"); //reset button  (clear all the Q values and state values to 0)
    button[5].hov_img = imread("/Users/shravyareddyakmy/Desktop/Masters/Summer2022/AI-580/MDP_GridWorld/MDP_GridWorld/imgs/reset_hover.png");
    button[5].clk_img = imread("/Users/shravyareddyakmy/Desktop/Masters/Summer2022/AI-580/MDP_GridWorld/MDP_GridWorld/imgs/reset.png");
    ...
    go_btn.org_img = imread("/Users/shravyareddyakmy/Desktop/Masters/Summer2022/AI-580/MDP_GridWorld/MDP_GridWorld/imgs/go.png"); //next button 0 (move one step forward)
    go_btn.hov_img = imread("/Users/shravyareddyakmy/Desktop/Masters/Summer2022/AI-580/MDP_GridWorld/MDP_GridWorld/imgs/go_hover.png");
    go_btn.clk_img = imread("/Users/shravyareddyakmy/Desktop/Masters/Summer2022/AI-580/MDP_GridWorld/MDP_GridWorld/imgs/pause_hover.png");
    ...
    go_btn.org_img_2 = imread("/Users/shravyareddyakmy/Desktop/Masters/Summer2022/AI-580/MDP_GridWorld/MDP_GridWorld/imgs/pause.png"); //next button 0 (move one step forward)
    go_btn.hov_img_2 = imread("/Users/shravyareddyakmy/Desktop/Masters/Summer2022/AI-580/MDP_GridWorld/MDP_GridWorld/imgs/pause_hover.png");
    go_btn.clk_img_2 = imread("/Users/shravyareddyakmy/Desktop/Masters/Summer2022/AI-580/MDP_GridWorld/MDP_GridWorld/imgs/go_hover.png");
    ...
    arrow_imgs[ACTION_EAST] = imread("/Users/shravyareddyakmy/Desktop/Masters/Summer2022/AI-580/MDP_GridWorld/MDP_GridWorld/imgs/east.png");
    arrow_masks[ACTION_EAST] = imread("/Users/shravyareddyakmy/Desktop/Masters/Summer2022/AI-580/MDP_GridWorld/MDP_GridWorld/imgs/east_mask.png", 0);
    ...
    arrow_imgs[ACTION_WEST] = imread("/Users/shravyareddyakmy/Desktop/Masters/Summer2022/AI-580/MDP_GridWorld/MDP_GridWorld/imgs/west.png");
    arrow_masks[ACTION_WEST] = imread("/Users/shravyareddyakmy/Desktop/Masters/Summer2022/AI-580/MDP_GridWorld/MDP_GridWorld/imgs/west_mask.png", 0);
    ...
    arrow_imgs[ACTION_NORTH] = imread("/Users/shravyareddyakmy/Desktop/Masters/Summer2022/AI-580/MDP_GridWorld/MDP_GridWorld/imgs/north.png");
    arrow_masks[ACTION_NORTH] = imread("/Users/shravyareddyakmy/Desktop/Masters/Summer2022/AI-580/MDP_GridWorld/MDP_GridWorld/imgs/north_mask.png", 0);
    ...
    arrow_imgs[ACTION_SOUTH] = imread("/Users/shravyareddyakmy/Desktop/Masters/Summer2022/AI-580/MDP_GridWorld/MDP_GridWorld/imgs/south.png");
    arrow_masks[ACTION_SOUTH] = imread("/Users/shravyareddyakmy/Desktop/Masters/Summer2022/AI-580/MDP_GridWorld/MDP_GridWorld/imgs/south_mask.png", 0);
